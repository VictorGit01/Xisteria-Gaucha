...
import { Dimensions, View, ActivityIndicator, ToastAndroid, BackHandler } from 'react-native';
    ...
    function sendNotification(value) {
        axios({
            ...
            data: {
                'to': userToken,
                'notification': {
                    'title': `Pedido #${data.request_number}`,
        ...
        return (
            <Page>
                ...
                >
                    ...
                    <InfoHeader>
                        <Title alignSelf='center' >Pedido #{data.request_number}</Title>
                        {data.remove_enabled && 
                        <BorderlessButton
