...
export default ({ item, nav }) => {
    ...
    function navToInfoPlace() {
        nav('InfoPlace', { data: item });
    }
        ...
        >
            ...
            <ItemTextArea style={{ justifyContent: 'center' }} >
                <ItemTextArea style={{ flexDirection: 'row', justifyContent: 'flex-start' }} >
                    <ItemText style={{ flex: 1, marginRight: normalize(5) }} >{item.full_name}</ItemText>
                ...
                <ItemTextArea style={{ 
                    ...
                    <View style={{ flexDirection: 'row' }} >
                        <TextInfo>{item.date}</TextInfo>
                        <TextInfo style={{ marginHorizontal: 5 }} >às</TextInfo>
                        <TextInfo>{item.time}</TextInfo>
                    </View>
